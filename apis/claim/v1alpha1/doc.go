...
// +k8s:conversion-gen=github.com/kform-dev/pkg-server/apis/claim
// +k8s:defaulter-gen=TypeMeta
// +groupName=claim.pkg.kform.dev

// v1alpha1 is the v1alpha1 version of the API.
package v1alpha1 // import "github.com/kform-dev/pkg-server/apis/claim/v1alpha1"
